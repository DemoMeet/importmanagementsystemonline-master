...
class ChipStonePurScreen extends StatefulWidget {
  const ChipStonePurScreen({Key? key}) : super(key: key);

  @override
  _ChipStonePurScreenState createState() => _ChipStonePurScreenState();
}

class _ChipStonePurScreenState extends State<ChipStonePurScreen> {
        ...
        SpeedDialChild(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ChipStonePurEntryScreen()));
            },
            label: 'Add Data',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Chip Stone Purchase'),
        actions: [
          TextButton(
              onPressed: () {
  ...
  final CollectionReference _collectionReference =
      FirebaseFirestore.instance.collection("cPurchase");
