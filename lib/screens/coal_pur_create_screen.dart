...
import 'package:importmanagementsystemonline/screens/coal_pur_list_screen.dart';
...
class CoalPURCreateScreen extends StatefulWidget {
  const CoalPURCreateScreen({Key? key}) : super(key: key);

  @override
  _CoalPURCreateScreenState createState() => _CoalPURCreateScreenState();
}

class _CoalPURCreateScreenState extends State<CoalPURCreateScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Add New Purchase Regular'),
        actions: [
          TextButton(
              onPressed: () {
      ...
      FirebaseFirestore.instance
        ...
        FirebaseFirestore.instance
          ...
          Navigator.pushReplacement(context,
              MaterialPageRoute(builder: (context) => CoalPURListScreen()));
        });
      });
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
