...
import 'coal_pur_create_screen.dart';
import 'dashboard.dart';

class CoalPURListScreen extends StatefulWidget {
  const CoalPURListScreen({Key? key}) : super(key: key);

  @override
  _CoalPURListScreenState createState() => _CoalPURListScreenState();
}

class _CoalPURListScreenState extends State<CoalPURListScreen> {
          ...
          SpeedDialChild(
              ...
              onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => CoalPURCreateScreen()));
              },
              label: 'Add Data',
              ...
              children: [
                ...snapshot.data!.docs
                    .where((QueryDocumentSnapshot<Object?> element) =>
                        element["lc"].toString().toLowerCase() == "purc" &&
      ...
      await FirebaseFirestore.instance
        ...
        for (var doc in querySnapshot.docs) {
          if (doc["year"]
              ...
              doc["lc"].toString().toLowerCase() == "purc") {
            /*FirebaseFirestore.instance
                .collection('coalarchive')
                .get()
                .then((QuerySnapshot querySnapshot) {
  ...
  void generatePdf() async {
    ...
    FirebaseFirestore.instance
        ...
        .then((QuerySnapshot querySnapshot) {
      for (var doc in querySnapshot.docs) {
        if (doc["lc"].toString().toLowerCase() == "purc") {
      ...
      final invoice = InvoiceCoal(
          _totalStock.toString(), _totalAmount.toString(), "sale", "0", _list);
