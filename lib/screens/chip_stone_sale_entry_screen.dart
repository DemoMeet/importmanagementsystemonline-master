...
class ChipStoneSalentryScreen extends StatefulWidget {
  const ChipStoneSalentryScreen({Key? key}) : super(key: key);

  @override
  _ChipStoneSalentryScreen createState() => _ChipStoneSalentryScreen();
}

class _ChipStoneSalentryScreen extends State<ChipStoneSalentryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Add Chip Stone Sale'),
        actions: [
          TextButton(
              onPressed: (){
                Navigator.push(
  ...
  void AddData() async {
    if (_formKey.currentState!.validate() && _date != null) {
      final ref = FirebaseFirestore.instance.collection("cStoneSales").doc();
      ...
      if (_chosenPort == "Shutarkandi") {
        ...
        FirebaseFirestore.instance
          ...
          FirebaseFirestore.instance
            ...
            companyModel.id = "chipstonesaleshutarkandi" + _invoice.toString();
            ...
            companyModel.remarks = "Chip Stone Sale Shutarkandi";
            ...
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => ChipStoneSaleScreen()));
          });
        });
        ...
        FirebaseFirestore.instance
          ...
          FirebaseFirestore.instance
            ...
            final ref2 = FirebaseFirestore.instance.collection("companies").doc();
            Company companyModel = Company();
            companyModel.id = "chipstonesaletamabil" + _invoice.toString();
            companyModel.name = _chosenCompanyName!;
            companyModel.contact = _chosenCompanyContact!;
            companyModel.address = "0";
            companyModel.credit = _price;
            companyModel.debit = "0";
            companyModel.remarks = "Chip Stone Sale Tamabil : " +  cft_value.toString() + " CFT";
            companyModel.invoice = _invoiceC.toString();
            companyModel.paymentTypes = "0";
            companyModel.paymentInfo = "0";
            companyModel.date = DateFormat('yyyy-MM-dd').format(_date!);
        ...
        FirebaseFirestore.instance
          ...
          FirebaseFirestore.instance
            ...
            final ref2 = FirebaseFirestore.instance.collection("companies").doc();
            Company companyModel = Company();
            companyModel.id = "chipstonesalebholaganj" + _invoice.toString();
            companyModel.name = _chosenCompanyName!;
            companyModel.contact = _chosenCompanyContact!;
            companyModel.address = "0";
            companyModel.credit = _price;
            companyModel.debit = "0";
            companyModel.remarks = "Chip Stone Sale Bholaganj : " +  cft_value.toString() + " CFT";
            companyModel.invoice = _invoiceC.toString();
            companyModel.paymentTypes = "0";
            companyModel.paymentInfo = "0";
            companyModel.date = DateFormat('yyyy-MM-dd').format(_date!);
